      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            {["Hoàn thành", "Huỷ bỏ"].includes(appointmentDetails?.status) &&
            !appointmentDetails?.doctor?.vip ? (
              <div>
                <h3 className="font-medium text-gray-700">Bác sĩ:</h3>
                <p className="text-gray-600">
                  {appointmentDetails?.doctor?.account?.name || "N/A"}
                </p>
              </div>
            ) : null}
            {appointmentDetails?.doctor?.vip ? (
            ...
            <div>
              ...
              <p className="text-gray-600">
                {appointmentDetails?.patientprofile.fullname || "N/A"}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                {appointmentDetails.payments[0]?.amount
                  ? `${appointmentDetails.payments[0]?.amount} VNĐ`
                  : "N/A"}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                {isVIP
                  ...
                  : appointmentDetails?.worktime?.startTime +
                      "-" +
                      appointmentDetails?.worktime?.endTime || "N/A"}
              </p>
            </div>
          </div>
        </div>
