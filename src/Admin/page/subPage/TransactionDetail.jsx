                        ...
                        {appointment && (
                            <>
                                <div className="flex text-gray-500">
                                    ...
                                    <span className="text-gray-900 font-medium">{appointment.patient.account.name || "N/A"}</span>
                                </div>
                                <div className="flex text-gray-500">
                                    <span className="min-w-[250px]">Điện thoại:</span>
                                    <span className="text-gray-900 font-medium">{appointment.patient.account.phone || "N/A"}</span>
                                </div>
                            </>
                        )}
                        <div className="flex text-gray-500">
